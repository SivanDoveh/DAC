...
experiments = [
    ...
    # {'name': 'save_data_use_extra_blip_cap_expanders', 'lora': 4, 'lr': 0.0000050, 'use_only_quality_captions': None,
    #  'pretrained': 'openai', 'use_extra_blip_cap_expanders': None,'save_data':None},
    # {'name': 'save_data_use_extra_blip_cap_expanders', 'lora': 4, 'lr': 0.0000050, 'use_only_quality_captions': None,
    #  'pretrained': 'openai', 'use_extra_blip_cap_expanders': None,},
    {
        "name": "save_data_use_extra_cc3m_expanders",
        "lora": 4,
        "lr": 0.0000050,
        "pretrained": "openai",
        "use_extra_cc3m_expanders": None,
        "save_data": None,
    },
]
