...
# models.extend(['use_only_quality_captions','RB_neg_use_only_quality_captions','rand_both_neg_use_only_quality_captions'])
# models.extend(['lr1_RB_neg_use_only_quality_captions','lr2_RB_neg_use_only_quality_captions','lr3_RB_neg_use_only_quality_captions'])
